...
public class ActivityValidator {
     ...
     */
    public ActivityValidator(final DataService dService) {
     ...
     * @throws InvalidPayloadException when activity information is invalid
     */
    public void validate(final Activity activity) throws InvalidPayloadException {
        empty(activity);
    }

    /**
     * Ensures activity object is not null.
     *
     * @param activity Activity
     * @throws InvalidPayloadException when activity is null
     */
    private static void empty(final Activity activity) throws InvalidPayloadException {
        if (activity == null) {
            String msg = "No activity information was provided";
            log.warn(msg);
